...
public class UserService {
	 ...
	 * @throws Exception
	 */
	public User selectUser(int uno) throws Exception {
		Connection conn = JDBCTemplate.getConnection();
		
		User user = dao.selectUser(conn, uno);
	...
	public int deleteUser(int uno) throws Exception{
		...
		int result = dao.deleteUser(conn, uno);
	...
	/** 6-1 ID, PW가 잉ㄹ치하는 회원이 있는지 조회(SELECT)
	 * @param userId
	 * @param userPw
	 * @return
	 */
