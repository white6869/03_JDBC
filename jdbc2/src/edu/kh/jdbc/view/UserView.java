...
public class UserView {
	 ...
	 * 
	 * -- 샂제 성공하였을때 : 삭제 성공
	 * -- 삭제 실패했을때 : 사용자 번호가 일치하는 User가 존재하지 않음
	 */
	...
	private void selectUser() throws Exception{
		...
		User user = service.selectUser(uno);
		
		if(user == null) {
			System.out.println( uno+"가 일치하는 회원 없음");
			return;
		}
	...
	private void insertUser() throws Exception{
		...
		int result = service.inserUser(user);
